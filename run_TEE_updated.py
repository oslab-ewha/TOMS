...
# ✅ 실험 모드 구성
modes = [
    # ✅ CO-DMO-DT: TEE 1, full features
    ("CO-DMO-DT", [
        (23, "0", "#0"),    # TEE = 0 → 주석 처리
        (24, "#1", "1"),    # TEE = 1 활성화
    ]),

    # ✅ CO-DMO: TEE 0, full features
    ("CO-DMO", [
        (23, "#0", "0"),
        (24, "1", "#1"),
        (23, "1", "0"),     # 혹시라도 남은 값 강제 초기화
    ]),

    # ✅ Offloading only: CPUFreq 못 씀
    ("Offloading", [
        (11, "0.5", "#0.5"),
        (12, "0.25", "#0.25"),
        (13, "0.125", "#0.125"),
    ...
    # ✅ DVS only: Offloading 못 씀
    ("DVS", [
        (20, "0", "#0"),    # offloading 0 주석
        (21, "1", "#1"),    # offloading 1 주석
    ]),
